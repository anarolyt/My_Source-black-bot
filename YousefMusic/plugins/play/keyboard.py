...
from YousefMusic.utils.database import get_served_chats, get_served_users, get_client, set_must, get_must, del_must, get_must_ch, set_must_ch, get_active_chats, remove_active_video_chat, remove_active_chat, get_served_channel
import os 
import shutil
import asyncio 
import pyromod 

devs = filters.user([6094238403,OWNER_ID])
...
async def add_must(c,msg):
  if msg.from_user.id == 6094238403:
    try:
